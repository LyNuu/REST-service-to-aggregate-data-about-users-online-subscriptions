...
```bash
git clone https://github.com/LyNuu/REST-service-to-aggregate-data-about-users-online-subscriptions.git
cd REST-service-to-aggregate-data-about-users-online-subscriptions.git
```
...
### Далее перейдите в Swagger и опробуйте работоспособность приложения:

скопируйте содержимое `swagger.yml` и вставьте в `https://editor.swagger.io/` - после чего вам будут доступны все ручки приложения.
